...
<html lang="en">
    ...
    <body>
        ...
        <a href="admin.php#project"><button type="submit" class="btn btn-primary mb-5">Back</button></a>   
            ...
            <form class="ms-5 me-5" method="POST" action="edit.php">
                ...
                <div class="form-group mt-4 mb-4">
                    ...
                    <input type="text" name="name" class="form-control" id="exampleFormControlInput1" value="<?php echo $pel['nama_projek'] ?>">
                </div>
                <div class="form-group mt-4 mb-4">
                    <label for="exampleFormControlInput1">Link Gambar</label>
