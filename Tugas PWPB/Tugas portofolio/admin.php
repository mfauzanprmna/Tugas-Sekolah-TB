  ...
  <head>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgb(3, 235, 235);">
            <div class="container">
                <a class="navbar-brand" href="#">Muhammad Fauzan Permana</a>
            ...
            <div class="container halaman">
                ...
                <div class="card project mt-2 ms-3 me-3 mb-3" style="width: 17rem; height: 17rem;">
                    ...
                    <div class="card tombol">
                        <a href="formeditmy.php?id=<?php echo $pela['id'] ?>" class="btn float-start"><img src="https://www.pngkey.com/png/full/202-2022557_edit-comments-edit-icon-png.png" alt="" width="30px" height="30px"></a>
                        <a href="hapus.php?id=<?php echo $pela['id'] ?>" class="btn dloat-end"><img src="https://icons-for-free.com/iconfiles/png/512/delete+remove+trash+trash+bin+trash+can+icon-1320073117929397588.png" alt="" width="30px" height="30px"></a>
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="modal-content">
                    ...
                    <form action="simpan.php" method="POST">
                        <div class="modal-body" style="overflow-y: scroll; height: 600px;">                  
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label fw-bold">Gambar</label>
                                <input required type="text" class="form-control" id="nama_pembeli" name="gambar1">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label fw-bold">Description</label>
                                <input type="text" class="form-control" id="nama_barang" name="desc">
                            </div>
                        </div>
        ...
        <div class="pt-3 pb-3" id="contact">
            ...
            <div class="container halaman mt-3 mb-3">
            <?php 
